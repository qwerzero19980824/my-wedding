...
> **最后更新**：2026-07-13
> **当前版本**：v3.22.0（`index.html` 内 `APP_VERSION` 已同步为 "3.22.0"）
...
| **十二海报立体轮转** | 线性叙事海报改为原生弧形 3D 舞台；连续轮转后减速、中心放大并出现强金色光晕，外围同步压暗；支持拖动、按钮、方向键和 50 张以上照片队列；故事照片按 720px / 约 34KB 分级压缩 | `index.html` |
